            ...
            <div class="row g-4">
                <div class="col-lg-6">
                    <div class="product-image">
                        <img src="{{ asset('public/uploads/products/' . $product->imageURL) }}" alt="{{ $product->name }}"
                ...
                <div class="col-lg-6">
                    <div class="product-details">
                        ...
                        @if ($product->brand)
                            <p class="text-muted mb-3">
                                <i class="fas fa-store me-2"></i>Thương hiệu: {{ $product->brand->TenThuongHieu }}
                            </p>
                        @endif
                        ...
                        <div class="mb-4">
                            ...
                            <ul class="list-unstyled">
                                <li><i class="fas fa-check text-success me-2"></i>Tồn kho: {{ $product->stockQuantity }}
                                    sản phẩm</li>
                            ...
                            <div class="add-to-cart-form mb-4">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-4">
                                        ...
                                        <input type="number" class="form-control" id="product-quantity" value="1"
            ...
            if (quantityInput && addToCartBtn) {
                quantityInput.addEventListener('change', function() {
                    ...
                    addToCartBtn.innerHTML =
                        `<i class="fas fa-shopping-cart me-2"></i> Thêm ${quantity} vào giỏ hàng`;
                });
            }
        });
    </script>
