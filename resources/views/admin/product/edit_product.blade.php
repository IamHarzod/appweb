    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <form id="formUpdateProduct" action="{{ url('/update-product/' . $product->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="price" value="{{ $product->price }}" placeholder="Nhập giá">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Số lượng tồn</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="stockQuantity" value="{{ $product->stockQuantity }}" placeholder="Nhập số lượng tồn kho">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-3 col-form-label">Giảm giá (%)</label>
                        <div class="col-sm-9">
                            <input type="number" step="0.01" class="form-control" name="discountPercent" value="{{ $product->discountPercent }}" placeholder="Nhập % giảm giá">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="IsActive" value="1" {{ $product->IsActive ? 'checked' : '' }}> Hiện
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="IsActive" value="0" {{ !$product->IsActive ? 'checked' : '' }}> Ẩn
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="style" value="{{ $product->style }}" placeholder="Nhập kiểu sản phẩm">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="input-group mb-3">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" accept=".jpg, .png, .jpeg" name="imageURL">
                                    <label class="custom-file-label">Chọn tệp</label>
                                </div>
                            </div>
                            @if($product->imageURL)
                                <img src="{{ asset('public/uploads/products/' . $product->imageURL) }}" width="100" height="100" alt="Ảnh sản phẩm">
                            @endif
                        </div>
                    </div>
                </div>
